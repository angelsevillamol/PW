...
public class ProgramaPrincipal {
	...
	private static void modificarUsuario() {   
	    ...
	    System.out.print("Introduzca el correo del usuario a modificar: ");
	 	...
	 	if (str == null || str.isEmpty()) {
	 		System.out.print("El correo electrónico es un campo obligatorio. ");
	 		return;
	 	}
			...
			switch (opt) {
				...
				case EMAIL:
					...
					if (str == null || str.isEmpty()) {
						...
						System.out.print("Ya existe un usuario con esa dirección de correo electrónico. ");
					}
					else {
						u.setEmail(str);
					}
	...
	private static void altaUsuario() {
		...
		Usuario u = new Usuario(0, nombre, apellidos, fechaNacimiento, email);
		gestorUsuarios.altaUsuario(u);
		System.out.print("Usuario dado de alta con éxito. ");
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("Bienvenido a la página de Karts.");
